<?php
include_once '../functions/student/get-gallery.php';
...
<head>
    ...
    <title>Student Gallery - Alumni Management System for Yllana Bay View College</title>
...
<body id="page-top">
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            <section id="gallery" class="py-4 py-xl-5">
                <div class="container">
                    <div class="text-dark bg-light border rounded border-0 border-light d-flex flex-column justify-content-between align-items-center flex-lg-row p-4 p-lg-5 shadow-sm" data-bs-theme="light">
                        <div class="text-center text-lg-start py-3 py-lg-1">
                            <h2 class="fw-bold mb-2">Alumni Gallery</h2>
